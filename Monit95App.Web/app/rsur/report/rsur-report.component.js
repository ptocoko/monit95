...
var rsur_report_service_1 = require("./rsur-report.service");
var RsurReportComponent = (function () {
    function RsurReportComponent(rsurReportService) {
        this.rsurReportService = rsurReportService;
    }
    RsurReportComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.rsurReportService.get().subscribe(function (res) { return _this.reportData = res; });
    };
