...
var RsurParticipTestProtocolComponent = (function () {
    function RsurParticipTestProtocolComponent(route, location, marksService) {
        this.route = route;
        this.location = location;
        this.marksService = marksService;
        this.rsurParticip = new RsurParticipMarks();
    }
    RsurParticipTestProtocolComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RsurParticipTestProtocolComponent.prototype.setAbsentStatus = function () {
        if (this.isAbsent) {
            this.marks.fill('X');
    ...
    RsurParticipTestProtocolComponent.prototype.onMarkChanged = function (event) {
    ...
    RsurParticipTestProtocolComponent.prototype.goToNextInputOrFocusOnSubmitBtn = function (elemIndex) {
    ...
    RsurParticipTestProtocolComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    RsurParticipTestProtocolComponent.prototype.getCurrentMarksArray = function () {
        console.log(this.marks);
    };
    RsurParticipTestProtocolComponent.prototype.cancel = function () {
        this.location.back();
    };
    return RsurParticipTestProtocolComponent;
}());
RsurParticipTestProtocolComponent = __decorate([
    core_1.Component({
        templateUrl: "./app/rsur/rsur-test-protocol/rsur-particip-test-protocol.component.html?v=" + new Date().getTime()
    }),
    __metadata("design:paramtypes", [router_1.ActivatedRoute,
        common_1.Location,
        marks_service_1.MarksService])
], RsurParticipTestProtocolComponent);
exports.RsurParticipTestProtocolComponent = RsurParticipTestProtocolComponent;
//# sourceMappingURL=rsur-test-protocol.js.map