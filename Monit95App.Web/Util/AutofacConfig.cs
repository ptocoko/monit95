...
namespace Monit95App.Util
{
    public class AutofacConfig
    {
        ...
        {      
            ...
            builder.RegisterType<RsurParticipEditService>().As<IRsurParticipEditService>().WithParameters(new List<Parameter> { new NamedParameter("unitOfWork", new UnitOfWorkV2(context)), new NamedParameter("participEditRepository", new GenericRepository<ProjectParticipsEdit>(new UnitOfWorkV2(context))), new NamedParameter("participRepository", new GenericRepository<ProjectParticip>(new UnitOfWorkV2(context))) });
