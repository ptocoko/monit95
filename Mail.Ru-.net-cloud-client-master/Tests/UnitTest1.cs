...
namespace MailRuCloudApi.Tests
{
    [TestClass]
    public class UnitTest1
    {
        private const string Login = "chr_coko.pto@mail.ru";
        private const string Password = "COKO95a";
        ...
        public void GetItemsTest()
        {
            ...
            Assert.IsTrue(items.Result.Files.Count == items.Result.NumberOfFiles || items.Result.Folders.Count == items.Result.NumberOfFolders);
        ...
        //    //var items = api.GetItems("/Reports/201656");
        //    //var fileToDownload = items.Files.First(t => t.Size.DefaultValue <= 1 * 1024 * 1024);
        //    //var publicFileLink = api.GetPublishLink(fileToDownload);

        //    var items = api.GetItems("/Reports/201656");
        //    var t = items.Result.Files;
        //    var fileToDownload = items.Result.Files.Where(x=>x.Name == "Абакаева-Линда-584815.pdf").Single();
        //    var publicFileLink = api.GetPublishLink(fileToDownload);

        //    Assert.IsTrue(!string.IsNullOrEmpty(publicFileLink.Result));
