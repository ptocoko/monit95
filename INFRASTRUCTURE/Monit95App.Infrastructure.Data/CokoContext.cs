...
namespace Monit95App.Infrastructure.Data
{
    public partial class CokoContext : DbContext
    {
        ...
        public virtual DbSet<FirstClassQuestion> FirstClassQuestions { get; set; }
        public virtual DbSet<FirstClassSubResult> FirstClassSubResults { get; set; }
        ...
        public virtual DbSet<RsurExamName> RsurExamNames { get; set; }
        ...
        public virtual DbSet<TwoThreeResultsMarks> TwoThreeResultsMarks { get; set; }
        public virtual DbSet<RsurElementResult> RsurElementResults { get; set; }
        public virtual DbSet<Element> Elements { get; set; }
        public virtual DbSet<VprWeek> VprWeeks { get; set; }
        public virtual DbSet<VprSchoolMarks> VprSchoolMarks { get; set; }
        public virtual DbSet<VprWeekSchool> VprWeekSchools { get; set; }

        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            modelBuilder.Entity<RsurTest>()
                .HasOptional(e => e.RsurExamName)
                .WithMany(e => e.RsurTests)
                .HasForeignKey(e => e.ExamCode);
            ...
            modelBuilder.Entity<FirstClassSubResult>()
                .HasRequired(e => e.ParticipTest)
                .WithMany(e => e.FirstClassSubResults)
                .HasForeignKey(e => e.ParticipTestId)
                .WillCascadeOnDelete(true);
            ...
            modelBuilder.Entity<VprWeekSchool>()
                .HasRequired(e => e.Week)
                .WithMany(e => e.VprWeekSchools)
