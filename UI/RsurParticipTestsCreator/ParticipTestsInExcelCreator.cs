...
namespace RsurParticipTestsCreator
{
    internal class ParticipTestsInExcelCreator
    {
        ...
        {
            var destFolder = $@"\\192.168.88.254\inetpub\wwwroot\monit95\file\rsur-particip-tests";
            var templatePath = @"\\192.168.88.254\inetpub\wwwroot\monit95\file\rsur-particip-tests\template2.xlsx";
        ...
        {
            var destFolder = $@"\\192.168.88.254\inetpub\wwwroot\monit95\file\rsur-particip-tests\schools";
            var templatePath = @"\\192.168.88.254\inetpub\wwwroot\monit95\file\rsur-particip-tests\template2_school.xlsx";
            var shortSubjectName = models.SubjectName.Substring(0, 2);
