...
exports.ParticipsListComponent = void 0;
...
var ParticipsListComponent = /** @class */ (function () {
    ...
    ParticipsListComponent.prototype.ngOnInit = function () {
        ...
        this.participsSub$ = (0, merge_1.merge)(this.paginator.page, search$, this.selectionChange$)
    ...
    ParticipsListComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/one-two-three/particips/list/particips-list.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/one-two-three/particips/list/particips-list.component.css?v=".concat(new Date().getTime())]
        }),
