...
export class HomeComponent {
	date = new Date();
	isBadSchool: boolean;
	schoolsToUploadParticips: any[] = [];
	schoolsToSaveResults: any[] = [];
	currentAreaCode: number;

	constructor(private account: AccountService, private cards: CardsService, private snackBar: MatSnackBar, private schoolsService: SchoolService) { }
