...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(account, cards, snackBar, schoolsService) {
        this.account = account;
        this.cards = cards;
        this.snackBar = snackBar;
        this.schoolsService = schoolsService;
        this.date = new Date();
        this.schoolsToUploadParticips = [];
        this.schoolsToSaveResults = [];
    }
    HomeComponent.prototype.ngOnInit = function () {
        ...
        var authSub = this.account.auth.subscribe(function (auth) {
            if (auth) {
                _this_1.schoolsService.getInfo(auth.UserName).subscribe(function (info) {
                    _this_1.currentAreaCode = info.AreaCode;
                    authSub.unsubscribe();
                });
            }
        });
    ...
    HomeComponent.prototype.downloadCards = function (projectId) {
        this.cards.getForSchool(projectId).subscribe(function (cards) {
            ...
            (0, functions_1.downloadFile)(url, 'результаты.zip');
        });
    };
    ...
    HomeComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/particips/home/home.component.html?v=".concat(new Date().getTime())
        }),
        tslib_1.__metadata("design:paramtypes", [account_service_1.AccountService, cards_service_1.CardsService, material_1.MatSnackBar, school_service_1.SchoolService])
    ], HomeComponent);
