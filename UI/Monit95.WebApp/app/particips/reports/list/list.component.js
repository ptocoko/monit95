...
exports.ReportsListComponent = void 0;
...
var ReportsListComponent = /** @class */ (function () {
    ...
    ReportsListComponent.prototype.createRequest = function () {
        return this.rsurReportService.getReportsList(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, this.schoolId && this.accountService.isArea() ? { schoolId: this.schoolId } : {}), this.testCode ? { testCode: this.testCode } : {}), this.searchParticipText ? { searchParticipText: this.searchParticipText } : {}), { projectId: this.projectId.toString(), page: (this.paginator.pageIndex + 1).toString(), pageSize: this.paginator.pageSize.toString() }));
    };
    ...
    ReportsListComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/particips/reports/list/list.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/particips/reports/list/list.component.css?v=".concat(new Date().getTime())]
        }),
