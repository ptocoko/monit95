...
exports.SchoolsReportsListComponent = void 0;
...
var SchoolsReportsListComponent = /** @class */ (function () {
    ...
    SchoolsReportsListComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/particips/reports2/schools-list/schools-reports-list.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/particips/reports2/schools-list/schools-reports-list.component.css?v=".concat(new Date().getTime())]
        }),
