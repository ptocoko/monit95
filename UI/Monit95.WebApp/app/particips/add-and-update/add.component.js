...
exports.AddParticipComponent = void 0;
...
var AddParticipComponent = /** @class */ (function () {
    ...
    AddParticipComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/particips/add-and-update/add.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/particips/add-and-update/add.component.css?v=".concat(new Date().getTime())]
        }),
