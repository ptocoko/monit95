...
var ParticipsListComponent = /** @class */ (function () {
    ...
    ParticipsListComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/particips/list/particips-list.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/particips/list/particips-list.component.css?v=".concat(new Date().getTime())]
        }),
