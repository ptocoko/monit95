...
import { MatemBasicChoice } from './matem-basic-choice/matem-basic-choice.component';
...
const routes: Routes = [
	...
	{ path: 'particips/new', component: AddParticipComponent, data: { projectId: 40, projectName: 'EГЭ' } },
	...
	{ path: 'particips/matem-base-choice', component: MatemBasicChoice },
