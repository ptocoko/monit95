...
exports.ClassParticipReportComponent = exports.ClassParticipResult = void 0;
...
var ClassParticipReportComponent = /** @class */ (function () {
    ...
    ClassParticipReportComponent.prototype.download = function () {
        ...
        this.http.get('/api/ResultReport/Get?participTestId=' + this.participTestId, { responseType: http_1.ResponseContentType.Blob }).subscribe(function (data) {
            ...
            a.download = "".concat(_this.particip.ClassName.replace(' ', ''), "-").concat(_this.particip.Surname, "-").concat(_this.particip.Name);
            a.click();
        });
    };
    ClassParticipReportComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/class-particips/results/particip-report.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/class-particips/results/particip-report.component.css?v=".concat(new Date().getTime())]
        }),
