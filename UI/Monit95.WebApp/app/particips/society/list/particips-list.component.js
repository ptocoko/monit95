...
exports.SocietyParticipsListComponent = void 0;
...
var SocietyParticipsListComponent = /** @class */ (function () {
    ...
    SocietyParticipsListComponent.prototype.checkboxLabel = function (row, index) {
        return "".concat(this.selection.isSelected(row) ? 'deselect' : 'select', " row ").concat(index + 1);
    };
    ...
    SocietyParticipsListComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/particips/society/list/particips-list.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/particips/society/list/particips-list.component.css?v=".concat(new Date().getTime())]
        }),
