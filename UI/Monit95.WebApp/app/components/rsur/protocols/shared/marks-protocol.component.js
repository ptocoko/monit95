...
exports.MarksProtocolComponent = void 0;
...
var MarksProtocolComponent = /** @class */ (function () {
    ...
    MarksProtocolComponent.prototype.ngAfterViewInit = function () {
        ...
        if (this.inputElements.get(0)) {
            ...
            this.keyUpSub$ = (0, fromEvent_1.fromEvent)(document.getElementsByClassName('markInput'), 'keyup')
                .pipe((0, filter_1.filter)(function (event) { return [38, 40].indexOf(event.keyCode) > -1; }))
        ...
        var labels = document.querySelectorAll('.markLabel');
        var maxWidth = Array.from(labels).map(function (labelElem) { return labelElem.clientWidth; }).reduce(function (agg, curr) { return agg = agg < curr ? curr : agg; }, 0);
        labels.forEach(function (labelEl) { return labelEl.style.width = maxWidth + 'px'; });
    };
    ...
    MarksProtocolComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            ...
            templateUrl: "./app/components/rsur/protocols/shared/marks-protocol.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/components/rsur/protocols/shared/marks-protocol.component.css?v=".concat(new Date().getTime())]
        })
