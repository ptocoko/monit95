...
exports.FilterPipe = exports.ScanProtocolsComponent = void 0;
...
var ScanProtocolsComponent = /** @class */ (function () {
    ...
    ScanProtocolsComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            ...
            templateUrl: "./app/components/rsur/protocols/scan/scan-protocols.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/components/rsur/protocols/scan/scan-protocols.component.css?v=".concat(new Date().getTime())]
        }),
