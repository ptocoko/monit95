...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getFileLink = function (examCode, subjectStart) {
        return "/file/rsur-particip-tests/".concat(this.account.UserName, "/").concat(examCode, "_").concat(subjectStart, "_\u0440\u0430\u0441\u043F\u0440\u0435\u0434\u0435\u043B\u0435\u043D\u0438\u0435_").concat(this.account.UserName, ".xlsx");
    };
    HomeComponent.prototype.getSchoolFileLink = function (examCode, subjectStart) {
        return "/file/rsur-particip-tests/schools/".concat(this.account.UserName, "/").concat(examCode, "_").concat(subjectStart, "_\u0440\u0430\u0441\u043F\u0440\u0435\u0434\u0435\u043B\u0435\u043D\u0438\u0435_").concat(this.account.UserName, ".xlsx");
    };
    ...
    HomeComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/components/rsur/home/home.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/components/rsur/home/home.component.css?v=".concat(new Date().getTime())]
        }),
