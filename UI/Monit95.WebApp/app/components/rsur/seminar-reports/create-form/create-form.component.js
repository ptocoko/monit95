...
exports.SeminarReportCreateFormComponent = void 0;
...
var SeminarReportCreateFormComponent = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _b = {
                            // 
                            key: isProtocol ? 'protocol' : "image_".concat(this.fileIndex++),
                    ...
                    case 3:
                        ...
                        _c.label = 4;
                    case 4:
                        seminarFile = (_b.base64String = _a,
                            _b);
    ...
    SeminarReportCreateFormComponent.prototype.validateFiles = function (files, isProtocolFiles) {
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            if (files[i].size > this.maxFileSize) {
                this.showMessage("\u0440\u0430\u0437\u043C\u0435\u0440 \u0444\u0430\u0439\u043B\u0430 ".concat(files[i].name, " \u043F\u0440\u0435\u0432\u044B\u0448\u0430\u0435\u0442 \u0434\u043E\u043F\u0443\u0441\u0442\u0438\u043C\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u0432 15 \u041C\u0411"));
                return false;
            }
        }
        if (!isProtocolFiles) {
    ...
    SeminarReportCreateFormComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/components/rsur/seminar-reports/create-form/create-form.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/components/rsur/seminar-reports/create-form/create-form.component.css?v=".concat(new Date().getTime())]
        }),
