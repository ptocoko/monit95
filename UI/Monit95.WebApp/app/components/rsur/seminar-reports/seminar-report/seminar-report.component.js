...
exports.SeminarReportComponent = void 0;
...
var SeminarReportComponent = /** @class */ (function () {
    ...
    SeminarReportComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.seminarReportService.getReport(rsurReportId).subscribe(function (res) {
                ...
                (0, fromEvent_1.fromEvent)(document, 'keydown').pipe((0, filter_1.filter)(function (e) { return [37, 39, 27].indexOf(e.keyCode) >= 0 && _this.viewingImage != null; }))
    ...
    SeminarReportComponent.prototype.showViewer = function (seminarFile) {
        if (seminarFile.Type === 'image')
            ...
            (0, functions_1.downloadFile)(seminarFile.FileUrl, "\u043F\u0440\u043E\u0442\u043E\u043A\u043E\u043B.".concat(seminarFile.Type));
        }
    };
    ...
    SeminarReportComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            ...
            templateUrl: "./app/components/rsur/seminar-reports/seminar-report/seminar-report.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/components/rsur/seminar-reports/seminar-report/seminar-report.component.css?v=".concat(new Date().getTime())]
        }),
