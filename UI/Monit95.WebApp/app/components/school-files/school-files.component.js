...
exports.SchoolFilesComponent = void 0;
...
var SchoolFilesComponent = /** @class */ (function () {
    ...
    SchoolFilesComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            ...
            templateUrl: "./app/components/school-files/school-files.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/components/school-files/school-files.component.css?v=".concat(new Date().getTime())]
        }),
