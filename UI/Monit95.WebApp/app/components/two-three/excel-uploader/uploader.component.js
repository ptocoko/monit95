...
exports.ExcelUploadComponent = void 0;
...
var ExcelUploadComponent = /** @class */ (function () {
    ...
    ExcelUploadComponent.prototype.ngOnInit = function () {
        ...
        var fileName;
        this.fileIdSub$ = this.getFileName().pipe((0, operators_1.switchMap)(function (filename) {
            fileName = filename;
    ...
    ExcelUploadComponent.prototype.uploadXlsx = function (evt) {
        ...
        if (validateFile(file)) {
            this.uploadFileSub$ = this.getFileName().pipe((0, operators_1.switchMap)(function (filename) {
                _this.uploadStatus = 'uploading';
                return _this.fileService.uploadFile(_this.repositoryId, file, filename, false, false);
            }), (0, operators_1.switchMap)(function (fileId) {
            ...
            dialogRef.afterClosed().subscribe(function (res) {
                if (res) {
                    _this.deleteFileSub$ = _this.fileService.deleteFile(_this.uploadedFileId)
                        .pipe((0, operators_1.switchMap)(function () { return _this.collectorService.isFinished(_this.collectorId, false); }))
                        .subscribe(function () {
    ...
    ExcelUploadComponent.prototype.getFileName = function () {
        ...
        return this.accountService.auth
            .pipe((0, operators_1.map)(function (auth) { return "".concat(_this.fileNamePrefix, "_").concat(auth.UserName, ".").concat(_this.downloadExt); }));
    };
...
function validateFile(file) {
    if ((0, functions_1.getFileExtension)(file.name) !== 'xlsx') {
