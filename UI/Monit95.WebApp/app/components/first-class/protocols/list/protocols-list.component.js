...
exports.ProtocolsListComponent = exports.CLASS_ID_KEY = void 0;
...
var ProtocolsListComponent = /** @class */ (function () {
    ...
    ProtocolsListComponent.prototype.ngOnInit = function () {
        ...
        //});
        this.searchClass = (0, local_storage_1.getFromLocalStorage)(exports.CLASS_ID_KEY);
        var search$ = (0, fromEvent_1.fromEvent)(this.participFioInput.nativeElement, 'input')
            .pipe((0, debounceTime_1.debounceTime)(1000));
        search$.subscribe(function () { return _this.pageIndex = 0; });
        (0, merge_1.merge)(this.paginator.page, search$, this.selectionChange$)
    ...
    ProtocolsListComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/components/first-class/protocols/list/protocols-list.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/components/first-class/protocols/list/protocols-list.component.css?v=".concat(new Date().getTime())]
        }),
