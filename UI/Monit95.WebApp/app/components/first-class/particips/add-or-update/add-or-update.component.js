...
var AddOrUpdateComponent = /** @class */ (function () {
    function AddOrUpdateComponent(participService, classService, router, route, location, fb, renderer) {
        ...
        this.monthDays = Array.from({ length: 32 }, function (val, key) { return key; }).splice(1);
        this.months = [
            {
                index: 0,
                name: 'Январь'
    ...
    AddOrUpdateComponent.prototype.classChanged = function () {
        if (this.classId.value && this.classId.value.length > 0) {
            (0, local_storage_1.setToLocalStorage)(particips_list_component_1.CLASS_ID_KEY, this.classId.value);
        }
    };
    ...
    AddOrUpdateComponent.prototype.setFormDefault = function () {
        var classId = (0, local_storage_1.getFromLocalStorage)('FIRST_CLASS_ID');
    ...
    AddOrUpdateComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/components/first-class/particips/add-or-update/add-or-update.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/components/first-class/particips/add-or-update/add-or-update.component.css?v=".concat(new Date().getTime())]
        }),
