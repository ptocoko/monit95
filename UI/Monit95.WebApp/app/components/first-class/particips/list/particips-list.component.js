...
exports.ParticipsListComponent = exports.CLASS_ID_KEY = void 0;
...
var ParticipsListComponent = /** @class */ (function () {
    ...
    ParticipsListComponent.prototype.ngOnInit = function () {
        ...
        this.collectorService.getCollectorState(COLLECTOR_ID).subscribe(function (state) {
            ...
            if (!_this.isFinished) {
                _this.searchClass = (0, local_storage_1.getFromLocalStorage)(exports.CLASS_ID_KEY);
                var search$ = (0, fromEvent_1.fromEvent)(_this.searchField.nativeElement, 'input')
                    .pipe((0, operators_1.debounceTime)(1000));
                search$.subscribe(function () { return _this.pageIndex = 0; });
                (0, merge_1.merge)(_this.paginator.page, search$, _this.selectionChange$)
                    .pipe((0, operators_1.startWith)({}), (0, operators_1.switchMap)(function () {
                    ...
                    return data.Items;
                }), (0, operators_1.takeUntil)(_this.isFinished$)).subscribe(function (particips) { return _this.particips = particips; });
            }
        });
    };
    ...
    ParticipsListComponent.prototype.deleteParticip = function (particip) {
        ...
        var dialogRef = this.dialog.open(confirm_dialog_component_1.ConfirmDialogComponent, {
            width: '400px',
            disableClose: true,
            data: { message: "\u0412\u044B \u0443\u0432\u0435\u0440\u0435\u043D\u044B \u0447\u0442\u043E \u0445\u043E\u0442\u0438\u0442\u0435 \u0438\u0441\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0443\u0447\u0430\u0441\u0442\u043D\u0438\u043A\u0430 '".concat(particip.Surname, " ").concat(particip.Name, " ").concat(particip.SecondName, "' \u0438\u0437 \u0434\u0438\u0430\u0433\u043D\u043E\u0441\u0442\u0438\u043A\u0438?") }
        });
    ...
    ParticipsListComponent.prototype.selectionChange = function () {
        this.pageIndex = 0;
        if (this.searchClass) {
            (0, local_storage_1.setToLocalStorage)(exports.CLASS_ID_KEY, this.searchClass);
        }
        else {
            (0, local_storage_1.removeFromLocalStorage)(exports.CLASS_ID_KEY);
        }
    ...
    ParticipsListComponent = tslib_1.__decorate([
        (0, core_1.Component)({
            templateUrl: "./app/components/first-class/particips/list/particips-list.component.html?v=".concat(new Date().getTime()),
            styleUrls: ["./app/components/first-class/particips/list/particips-list.component.css?v=".concat(new Date().getTime())]
        }),
